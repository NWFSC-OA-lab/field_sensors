...
void setup() {                                        //set up the hardware
  ...
  Serial.println("Testing the conductivity sensor");
...
void loop() {                                         //here we go...
  ...
  if (input_string_complete == true) {                //if a string from the PC has been received in its entirety
    Serial3.println(inputstring);                       //send that string to the Atlas Scientific product
    Serial3.println('\r');                              //add a <CR> to the end of the string
